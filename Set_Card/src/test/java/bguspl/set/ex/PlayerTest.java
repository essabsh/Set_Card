...
class PlayerTest {
    ...
    private void pressing(){
        player.keyPreesTest(0);
        player.keyPreesTest(1);
        player.keyPreesTest(2);
    }
    @Test
    void check(){
        pressing();
        assertEquals(3,player.TokenNum);
    }
    @Test
    void checkSleeping(){
        assertEquals(0,player.sleeptime);
        player.point();
        assertEquals(1000,player.sleeptime);
    }
}